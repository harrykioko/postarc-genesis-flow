...
export const DemoCTA = ({ 
  ...
  return (
    <div className={`text-center ${className}`}>
      <Button 
        onClick={onClick}
        className={`bg-neon text-midnight hover:bg-neon/90 font-semibold rounded-xl hover:shadow-2xl hover:shadow-neon/30 hover:scale-105 transform transition-all duration-300 group ${
          isPrimary 
            ? "px-12 py-6 text-xl" 
            : "px-8 py-4 text-lg"
        }`}
